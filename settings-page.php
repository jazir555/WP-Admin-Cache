    ...
    <form method="post" action="">
        ...
        <div id="wac-tab-basic" class="wac-tab-content" style="display:block;">
            <table class="form-table">
                ...
                <!-- Early Plugin Initialization Toggle -->
                <tr>
                    <th scope="row"><?php _e( 'Early Plugin Initialization', 'wp-admin-cache' ); ?></th>
                    <td>
                        <input type="checkbox" name="early_init" value="1" <?php checked( $this->settings['early_init'] ?? false, true ); ?> />
                        <p class="description"><?php _e( 'Enable this option to move the plugin to the top of the active plugins list during initialization.', 'wp-admin-cache' ); ?></p>
                    </td>
                </tr>
            </table>
        </div>
        ...
        <div id="wac-tab-purge" class="wac-tab-content" style="display:none;">
            ...
            <table class="form-table">
                <tr>
                    ...
                    <td>
                        <label>
                            <input type="checkbox" name="full_purge_events[]" value="activated_plugin" <?php checked( in_array( 'activated_plugin', $this->settings['full_purge_events'] ?? array() ), true ); ?> />
							<?php _e( 'Plugin Activated', 'wp-admin-cache' ); ?>
                        </label><br/>
                        <label>
                            <input type="checkbox" name="full_purge_events[]" value="deactivated_plugin" <?php checked( in_array( 'deactivated_plugin', $this->settings['full_purge_events'] ?? array() ), true ); ?> />
							<?php _e( 'Plugin Deactivated', 'wp-admin-cache' ); ?>
                        </label>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <label>
                            <input type="checkbox" name="user_purge_events[]" value="wp_insert_post" <?php checked( in_array( 'wp_insert_post', $this->settings['user_purge_events'] ?? array() ), true ); ?> />
							<?php _e( 'Post Inserted/Created', 'wp-admin-cache' ); ?>
                        </label><br/>
                    </td>
                </tr>
            </table>
        ...
        <div id="wac-tab-advanced" class="wac-tab-content" style="display:none;">
            ...
            <table class="form-table">
                ...
                <tr>
                    ...
                    <td>
                        <textarea name="regex-urls" rows="5" cols="50" placeholder="<?php _e( '/pattern/', 'wp-admin-cache' ); ?>"><?php echo esc_textarea( implode( "\n", $this->settings['regex-urls'] ?? array() ) ); ?></textarea>
                    </td>
                </tr>
            </table>
        </div>
        ...
        <div id="wac-tab-manual" class="wac-tab-content" style="display:none;">
            ...
            <table class="form-table">
                <tr>
                    ...
                    <td>
                        <textarea name="manual-urls" rows="5" cols="50" placeholder="<?php _e( 'e.g. https://example.com/wp-admin/index.php', 'wp-admin-cache' ); ?>"><?php echo esc_textarea( implode( "\n", $this->settings['manual-urls'] ?? array() ) ); ?></textarea>
                ...
                <tr>
                    ...
                    <td>
                        <label>
                            <input type="checkbox" name="exact_manual_match" value="1" <?php checked( $this->settings['exact_manual_match'] ?? false, true ); ?> />
							<?php _e( 'Enable exact matching (the URL must match exactly after stripping the scheme).', 'wp-admin-cache' ); ?>
                        </label>
                    </td>
                </tr>
            </table>
